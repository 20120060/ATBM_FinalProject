...
EXECUTE SA_USER_ADMIN.SET_USER_LABELS('QLNV','NV0004','TP:MB,SX,GC:MB');
GRANT SELECT ON OLS_TEST1.THONGBAO TO NV0004;
--
EXECUTE SA_USER_ADMIN.SET_USER_LABELS('QLNV','NV0041','TP:SX:MN');
