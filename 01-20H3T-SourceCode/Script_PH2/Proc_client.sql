...
END;
/
CREATE OR REPLACE PROCEDURE PROC_UPDATE_TAICHINH (COL VARCHAR2,VAL RAW, MA VARCHAR2,CONCOL VARCHAR2, TAB VARCHAR2)
AS
    STR VARCHAR2(10000);
BEGIN 
    IF COL='NGAYSINH' OR COL='THOIGIAN' OR COL='NGAYBD' THEN
...
GRANT EXECUTE ON OLS_TEST1.PROC_UPDATE_TAICHINH TO TAICHINH;
-- THE ANH CODE
